...
import { Scale, ArrowLeft, MessageCircle, Bot, Zap } from "lucide-react";
      ...
      <div className="relative z-10 container mx-auto px-4 py-12">
        <motion.div className="max-w-4xl mx-auto text-center" {...fadeInUp}>
          ...
          <p className="text-xl text-white/60 mb-12 max-w-2xl mx-auto">
            Your intelligent legal assistant for instant answers and guidance is coming soon.
          </p>
          ...
          <Card className="glass-card bg-white/5 backdrop-blur-xl border border-white/10 shadow-2xl">
            <CardHeader>
              ...
              <CardDescription className="text-white/60">
                We're building an advanced AI chatbot to help with your legal questions.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
                <div className="text-center p-4 rounded-lg bg-white/5 border border-white/10">
                  ...
                  <h3 className="text-white font-semibold">Instant Answers</h3>
                  <p className="text-white/60 text-sm">Get quick legal guidance</p>
                </div>
                <div className="text-center p-4 rounded-lg bg-white/5 border border-white/10">
                ...
                <div className="text-center p-4 rounded-lg bg-white/5 border border-white/10">
                  ...
                  <p className="text-white/60 text-sm">Always ready to help</p>
                </div>
              </div>
            </CardContent>
          </Card>
