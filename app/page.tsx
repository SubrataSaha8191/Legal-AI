...
export default function LegalAILanding() {
  ...
  return (
    <div className="min-h-screen relative">
      ...
      {/* Hero Section with extra top padding for fixed navbar */}
      <section className="pt-32 md:pt-40 pb-20 px-4 relative z-10 min-h-screen flex items-center">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-3 text-black/70">
                <li>
                  <a href="#" className="hover:text-black transition-colors hover:underline">
                    Help Center
                  </a>
                </li>
                <li>
